...
class DashedBorderContainer extends StatelessWidget {
  ...
  final double strokeWidth; // thickness of the dash
  final double dashWidth;   // length of each dash
  final double gapWidth;    // space between dashes
...
class DashedBorderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    drawDashedLine(Offset(0, size.height), Offset(size.width, size.height)); // Bottom
