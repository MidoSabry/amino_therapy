...
class _RadioButtonsListState extends State<RadioButtonsList> {
  ...
  void initState() {
    ...
    _options.addAll(widget.values);
    super.initState();
  }

  @override
  void didUpdateWidget(covariant RadioButtonsList oldWidget) {
    if (!areListsEqualDeep(widget.values, oldWidget.values)) {
      _selectedValue = null;
    } else if (widget.initialSelection != oldWidget.initialSelection) {
      _selectedValue = widget.initialSelection;
    }
              ...
              children: List.generate(
                ...
                (index) => Row(
                  ...
                  children: [
                    ...
                    PText(
                      title: _options[index]?.toString().tr() ?? '',
